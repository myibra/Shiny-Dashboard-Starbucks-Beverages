...
plot1_test <- ggplot(agg_test) +
  ...
  scale_y_continuous(trans = "reverse", breaks = seq(0, 600, by = 100)) +
  scale_x_discrete(position = "top") +
  theme(
    axis.text.y = element_blank()
  ) +
...
plot1_test2 <- ggplot(agg_test2) +
  ...
  theme(
    axis.text.y = element_text(size = 12, hjust = 0.5, margin=margin(r=30))
  ) +
  labs(x = "") +
  coord_flip()
...
gridExtra::grid.arrange(plot1_test, plot1_test2, ncol = 2, widths = c(1, 1.2))
```
