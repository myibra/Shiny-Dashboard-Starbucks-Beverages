...
comp_beverage$nutrition <- comp_beverage$nutrition %>% 
  replace(comp_beverage$nutrition == 'calories', 'Calories (kcal)') %>% 
  replace(comp_beverage$nutrition == 'total_fat_g', 'Total Fat (g)') %>% 
  replace(comp_beverage$nutrition == 'saturated_fat_g','Saturated Fat (g)') %>% 
  replace(comp_beverage$nutrition == 'trans_fat_g','Trans Fat (g)') %>% 
  replace(comp_beverage$nutrition == 'cholesterol_mg','Cholesterol (g)') %>% 
  replace(comp_beverage$nutrition == 'sodium_mg','Sodium (mg)') %>% 
  replace(comp_beverage$nutrition == 'total_carbs_g','Total Carbs (g)') %>% 
  replace(comp_beverage$nutrition == 'fiber_g','Fiber (g)') %>% 
  replace(comp_beverage$nutrition == 'sugar_g','Sugar (g)') %>% 
  replace(comp_beverage$nutrition == 'caffeine_mg','Caffeine (mg)') 
